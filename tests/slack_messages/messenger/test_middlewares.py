...
from tests.messenger._factories import MessageRequestFactory, MessageResponseFactory
from tests.messenger._helpers import MockBackend, MockTemplateLoader
from tests.slack_messages._factories import SlackGetPermalinkResponseFactory
        ...
        "messengers": {
            "test-django-middleware": {
                ...
                "kwargs": {
                    "template_loaders": [
                        {
                            "class": "django_slack_tools.slack_messages.messenger.DjangoPolicyTemplateLoader",
                            "kwargs": {},
                        },
                    ],
                    "middlewares": [
                        {
                            "class": "django_slack_tools.slack_messages.messenger.DjangoDatabasePersister",
                            "kwargs": {},
                        },
                    ],
                    "messaging_backend": {
